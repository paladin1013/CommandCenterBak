...
CFDZeroCross0 = 20 # you can change this (in mV)
CFDLevel0 = 20 # you can change this (in mV)
CFDZeroCross1 = 0 # you can change this (in mV)
CFDLevel1 = 40 # you can change this (in mV)
...
with open("output.txt", "w") as outputfile:
    while True:
        ...
        if nactual.value > 0:
            ...
            t = (ctypes.c_uint*nactual.value)(*buffer[0:nactual.value])
            for i in t:
                outputfile.write(f"chn{str(i>>28)}  {str((i&(2**28-1))*4):>12}\n")
            progress += nactual.value
            sys.stdout.write(f"\rProgress:{progress}, {t}")
            sys.stdout.flush()
        else:
